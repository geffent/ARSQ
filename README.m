...
% and the Geriatric Psychiatry Neuroimaging (GPN Lab, contact
% aizen@pit.edu/andrcx@upmc.edu) at the University of Pittsburgh.

% Last updated 2019/10/02

% To launch the task, write ARSQ('subjID','right') - the first argument is
% the subject ID (can be any string) and the second one is either 'right'
% or 'left' for the hand they will be using to answer their questions.
...
% The different factors are: Discontinuity of Mind (DOM) - 'I felt
% restless, busy thoughts, rapidly switching thoughts, had thoughts under
% control'
